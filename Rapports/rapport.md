...
La planification s'est faite à l'aide d'un diagramme GANTT. Celui-ci diffère de celui présenté en début de projet, car nous avons finalement décidé de ne pas réaliser toutes les versions du projet proposées dans la consigne. Nous avons donc modifié le diagramme pour celui ci-dessous. La nouvelle planificationa été respéctée durant tout le projet.
...
gantt
    ...
    Planification          :a1, 2020-02-07, 12h
    Cahier des charges     :a2, after a1, 36h
    Charte graphique       :a3, after a2, 2d

    section Programmation
    Définition des classes :prog1, after a3, 10d
    Lecure du fichier JSON :prog2, after prog1, 10d
    Récupération du fichier JSON :prog3, after prog2, 10d
    Interface graphique :prog4, after prog3, 10d
    Correction de problèmes: prog5, after cr1, 10d

    section Compte-rendu
    Rédaction du rapport :cr1, after prog4, 15d
    Rédaction du rapport :cr2, after prog5, 15d
    Préparation de la soutenance:cr3, after cr2, 10d
```
...
![CharteGraphique](assets/CharteGraphique.png)
